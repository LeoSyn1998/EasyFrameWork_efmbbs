                        ...
                        <div class="mdl-card__subtitle-text">
                            <form name="updateUserInfo" action="/user/updateUserInfo" method="post">
                                <table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp">
                                    ...
                                    <tr>
                                        <td>
                                            <button type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-color--pink-400 mdl-color-text--white">修改</button>
                                        </td>
                                        <td>
                                            <div align="left">
                                                <a href="/main" class="mdl-button mdl-js-button mdl-button--raised">返回首页</a>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
