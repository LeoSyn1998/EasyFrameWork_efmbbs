    ...
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            ...
            <%--<a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400"--%>
               <%--href="/board/listPosts-<%=request.getParameter("boardId")%>">EFMbbs</a>--%>
            <a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400" href="/main">EFMbbs</a>
                            ...
                            <form action="/post/addPost" method="post">
                                <table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable center card-width">
                                        ...
                                        <td>
                                            <div class="mdl-textfield mdl-js-textfield">
                                                <input class="mdl-textfield__input" name="postBoardId" id="postBoardId"
                                                       readonly value="<%=session.getAttribute("boardId")%>"/>
                                        ...
                                        <td>
                                            <div class="mdl-textfield mdl-js-textfield">
                                                <input class="mdl-textfield__input" name="postUserName" id="postUserName"
                                                       readonly value="<%=session.getAttribute("username")%>"/>
                                        ...
                                        <%--<td>--%>
                                            <%--<div class="mdl-textfield mdl-js-textfield">--%>
                                                <%--<input class="mdl-textfield__input"--%>
                                                       <%--name="postBoardId"--%>
                                                       <%--id="postBoardId">--%>
                                                       <%--&lt;%&ndash;readonly value="<%=session.getAttribute("boardId")%>"/>&ndash;%&gt;--%>
                                                <%--<label class="mdl-textfield__label" for="postBoardId"></label>--%>
                                            <%--</div>--%>
                                        <%--</td>--%>
                                    <%--</tr>--%>
                                        ...
                                        <%--<td>--%>
                                            <%--<div class="mdl-textfield mdl-js-textfield">--%>
                                                <%--<input class="mdl-textfield__input" type="text"--%>
                                                       <%--name="postUserName"--%>
                                                       <%--id="postUserName">--%>
                                                       <%--&lt;%&ndash;readonly value="<%=session.getAttribute("userName")%>"/>&ndash;%&gt;--%>
                                                <%--<label class="mdl-textfield__label" for="postUserName"></label>--%>
                                            <%--</div>--%>
                                        <%--</td>--%>
                                    <%--</tr>--%>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="mdl-textfield mdl-js-textfield">
                                                <input class="mdl-textfield__input"  name="postTitle"
                                                       id="postTitle">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="mdl-textfield mdl-js-textfield">
                                                <textarea class="mdl-textfield__input"  name="postContent" rows="5" maxrows="5"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/board/listPosts?boardId=${boardId}" class="mdl-button mdl-js-button mdl-button--raised">返回</a>
                                        </td>
                                    </tr>
                                </table>
                            </form>
